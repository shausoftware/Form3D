...
public class ComplexStack2 : MonoBehaviour, IStack {
	...
	public IStack initialise(Vector3 centroid, Vector3 stackTwist, float scale, Color stackColour) {
		...
		orbitStack1.transform.position = new Vector3(centroid.x - (0.5f * scale), centroid.y, centroid.z);
		...
		orbitStack1.transform.localScale = new Vector3(scale * 0.3f, scale * 0.3f, scale * 0.3f);
		...
		orbitStack2.transform.position = new Vector3(centroid.x + (0.5f * scale), centroid.y, centroid.z);
		//rotate position about centre of stack
		GeometryUtility.rotateCoordinateAboutPoint (centroid, orbitStack2.transform.position, stackTwist);
		orbitStack2.transform.localScale = new Vector3(scale * 0.3f, scale * 0.3f, scale * 0.3f);
		...
		orbitStack3.transform.position = new Vector3(centroid.x, centroid.y, centroid.z - (0.5f * scale));
		//rotate position about centre of stack
		GeometryUtility.rotateCoordinateAboutPoint (centroid, orbitStack3.transform.position, stackTwist);
		orbitStack3.transform.localScale = new Vector3(scale * 0.3f, scale * 0.3f, scale * 0.3f);
		...
		orbitStack4.transform.localScale = new Vector3(scale * 0.3f, scale * 0.3f, scale * 0.3f);
